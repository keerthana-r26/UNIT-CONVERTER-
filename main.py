...
if change == 1:
    ...
    # ==== converting ====
    if length_convert == 1:
        print("{} cm is equal to {} m.".format(
            length_value, length_value / 100))
    elif length_convert == 2:
        print("{} m is equal to {} cm.".format(
            length_value, length_value * 100))
    elif length_convert == 3:
        print("{} cm is equal to {} inch.".format(
            length_value, length_value / 2.54))
    elif length_convert == 4:
        print("{} inch is equal to {} cm.".format(
            length_value, length_value * 2.54))
    elif length_convert == 5:
        print("{} cm is equal to {} km.".format(
            length_value, length_value / 100000))
    elif length_convert == 6:
        print("{} km is equal to {} cm.".format(
            length_value, length_value * 100000))
    elif length_convert == 7:
        print("{} cm is equal to {} feet.".format(
            length_value, length_value / 30.48))
    elif length_convert == 8:
        print("{} feet is equal to {} cm.".format(
            length_value, length_value * 30.48))
    elif length_convert == 9:
        print("{} KM is equal to {} mile".format(
            length_value, length_value / 1.609))
    elif length_convert == 10:
        print("{} mile is equal to {} KM".format(
            length_value, length_value * 1.609))
    elif length_convert == 11:
        print("{} cm is equal to {} feet".format(
            length_value, length_value / 30.48))
    elif length_convert == 12:
        print("{} feets is equal to {} inches".format(
            length_value, length_value * 12))
    elif length_convert == 13:
        print("{} sqfts is equal to {} sqmtrs".format(
            length_value, length_value / 10.764))
    elif length_convert == 14:
        print("{} sqfts is equal to {} Hecter/Acers".format(
            length_value, length_value / 107639))
...
# ==== Type 2 (Mass) ====
    ...
    if mass_convert == 1:
        ...
        print("{} mg is equal to {} kg".format(
            mass_value, mass_value / 1000000))
    elif mass_convert == 6:
        print("{} Kg is equal to {} mg".format(
            mass_value, mass_value * 1000000))
    elif mass_convert == 7:
        ...
        print("{} Kg is equal to {} lb".format(
            mass_value, mass_value * 2.20462))
    elif mass_convert == 10:
        print("{} lb is equal to {} kg".format(
            mass_value, mass_value / 2.20462))
...
# ==== Type 5 (Speed) ====
    ...
    # ==== converting ====
    if Spead_convert == 1:
        print("{} Ml is equal to {} Km".format(
            Spead_value, Spead_value * 1.609))
    elif Spead_convert == 2:
        print("{} Km is equal to {} Ml".format(
            Spead_value, Spead_value / 1.609))
    elif Spead_convert == 3:
        print("{} Ml is equal to {} M".format(
            Spead_value, Spead_value / 2.237))
    elif Spead_convert == 4:
        print("{} M is equal to {} Ml".format(
            Spead_value, Spead_value * 2.237))
...
# ==== Type 6 (Energy) ====
    ...
    Energy_convert = int(
        input("\nWhich conversion you want to do from 1 to 6: "))
    if Energy_convert == 1:
        print("{} J is equal to {} Kj".format(
            Energy_value, Energy_value / 1000))
    elif Energy_convert == 2:
        print("{} Kj is equal to {} J".format(
            Energy_value, Energy_value * 1000))
    elif Energy_convert == 3:
        print("{} J is equal to {} Kc".format(
            Energy_value, Energy_value / 4184))
    elif Energy_convert == 4:
        print("{} Kc is equal to {} J".format(
            Energy_value, Energy_value * 4184))
    elif Energy_convert == 5:
        print("{} Kj is equal to {} Kc".format(
            Energy_value, Energy_value / 4.184))
    elif Energy_convert == 6:
        print("{} Kc is equal to {} Kj".format(
            Energy_value, Energy_value * 4.184))
    else:
        print("Sorry, Please type correct number from 1 to 6.")
...
# ==== Type 7 (Pressure) ====
    ...
    for keys, values in Pressure_dict.items():
        print("{:2}. {}".format(keys, values))
    Pressure_convert = int(
        input("\nWhich conversion you want to do from 1 to 6: "))

    # ==== converting ====
    if Pressure_convert == 1:
        print("{} Bar is equal to {} P".format(
            Pressure_value, Pressure_value * 100000))
    elif Pressure_convert == 2:
        print("{} Bar is equal to {} atm".format(
            Pressure_value, Pressure_value / 1.013))
    elif Pressure_convert == 3:
        print("{} P is equal to {} Bar".format(
            Pressure_value, Pressure_value / 100000))
    elif Pressure_convert == 4:
        print("{} P is equal to {} atm".format(
            Pressure_value, Pressure_value / 101300))
    elif Pressure_convert == 5:
        print("{} atm is equal to {} P".format(
            Pressure_value, Pressure_value * 101300))
    elif Pressure_convert == 6:
        print("{} atm is equal to {} Bar".format(
            Pressure_value, Pressure_value * 1.013))
    else:
        print("Sorry, Please type correct number from 1 to 6.")
else:
